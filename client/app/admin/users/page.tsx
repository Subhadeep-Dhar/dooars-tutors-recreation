...
export default function AdminUsersPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-slate-900 mb-6">Users ({total})</h1>
            ...
            <CardContent className="p-4 flex items-center justify-between gap-4 flex-wrap">
              ...
              {user.role !== 'admin' && (
                <Button
                  ...
                  className={`h-8 text-xs ${!user.isActive ? 'text-green-600 border-green-200' : 'text-red-600 border-red-200'}`}
