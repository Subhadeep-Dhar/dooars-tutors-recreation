...
export const LaurelWreathSvg = ({ color = "currentColor", size = 100, className = "" }: { color?: string; size?: number; className?: string }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 512 512" 
...
export const LaurelBadge = ({ title, description, color }: { title: string; description: string; color: string }) => {
  return (
    <div className="flex flex-col items-center justify-center text-center mt-4">
      <div className="relative flex items-center justify-center w-[120px] h-[80px] mb-2">
        <LaurelWreathSvg color={color} size={120} className="absolute inset-0 opacity-90 top-[5px]" />
        <span 
          className="font-bold text-[0.7rem] tracking-widest uppercase relative z-10 px-2 mt-2 max-w-[95%]" 
          style={{ color: color, lineHeight: '1.2' }}
        >
          {title}
        </span>
      </div>
